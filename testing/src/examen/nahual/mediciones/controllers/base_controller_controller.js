 ...
 * Base class for Nahual.Mediciones controllers.
 */
$.Controller.extend('Nahual.Mediciones.Controllers.BaseController',
/* @Static */
{
	defaults: {
		startLoading: false
 ...
 */
 ...
 normalizeViewPath: function( view ){
	...
	var versionPostfix = Nahual.Mediciones.Controllers.BaseController.basePathVersionPostfix;
